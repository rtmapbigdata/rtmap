...
public class EventSerializer extends AbstractFlumeInterceptor {
	...
	final static String COLUMNS = String.format("%s %s %s %s %s", HeaderConstants.DEF_UNIT_CODE, HeaderConstants.DEF_PROCESS_DATE, HeaderConstants.DEF_FILENAME, HeaderConstants.DEF_BATCH_ID, HeaderConstants.DEF_COMPRESS);
